...
export default function Login() {
  ...
  // Read redirect param — supports both ?redirect= query param and location.state.from (set by auth guard)
  ...
  return (
    <>
      <Helmet>
        <title>Sign In | Vaishnav Rug Collection</title>
        <meta name="description" content="Access your VRC account, order milestones and customized rugs inquiries." />
      </Helmet>
      ...
      <AuthContainer
        ...
        handleGoogleSignIn={handleGoogleSignInPopup}
      />
    </>
  )
}
